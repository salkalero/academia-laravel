...
<body class="bg-gray-100 min-h-screen p-6 sm:p-12 font-sans flex items-center justify-center">
    ...
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md border border-gray-200">
        ...
        <div class="mb-6">
            <h1 class="text-2xl font-extrabold text-gray-800">Nueva Asignatura</h1>
            <p class="text-xs text-gray-400 mt-0.5">Añade un nuevo curso al plan de estudios de DAW</p>
        </div>

        <form action="/asignaturas" method="POST" class="space-y-4">
        ...
        <!-- Mostrar errores de validación -->
            ...
            <div>
                <label for="nombre" class="block text-sm font-bold text-gray-700 mb-1">Nombre de la asignatura</label>
                <input type="text" name="nombre" id="nombre" placeholder="Ej: Despliegue de Aplicaciones Web"
            ...
            <div>
                <label for="horas" class="block text-sm font-bold text-gray-700 mb-1">Carga Horaria (en horas)</label>
                <input type="number" name="horas" id="horas" placeholder="Ej: 100"
                    class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-200 focus:border-red-500 outline-none transition-all">
            </div>

            <div class="flex items-center justify-end space-x-3 pt-2">
                <a href="/asignaturas" class="text-sm font-semibold text-gray-500 hover:text-gray-700 transition-colors">
                    Cancelar
                </a>
                <button type="submit"
